<?php
    ...
    if(!empty($events))
    {
        ...
        for($i = 0; $i < $eventLen; $i++) {
            ...
            echo '<div class="lesnAd">';
            $numb += 1;
            echo '<img class="deleteEvent nodisp" name="'.$events[$y]['name'].'" src="/img/x-circle.svg"><div class="addHead"><div class="numberAd"><p>'.$numb.'</p></div>
